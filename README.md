...
​Technical Breakdown
​This section demonstrates your technical competency.
​Tool: Microsoft Power BI Desktop
​Data Source: Synthetic Transactional Data (as shown in the Table View screenshot), including customer_id, order_date, product_name, price, quantity, payment_method, and review_score.
​Key Power BI Skills Demonstrated:
​Data Modeling: Establishing a star or snowflake schema (even if implicit for this size of data).
​ETL (Extract, Transform, Load): Using Power Query Editor for data cleaning, type conversion (e.g., date formats, currency), and creating new columns (Day Name, Month Name, Age breakdown).
​DAX Measures & Calculated Columns: Creating measures for Total Sales, Average Review Score, and potentially ranking measures (e.g., Expenditure Rank Per Seller).
​Advanced Visualizations: Utilizing geographical maps, line charts for time-series analysis, bar/column charts for comparisons, and a gauge/donut chart for Total Sales KPI.
​Interactive Filtering: Implementing slicers for Payment Method and Age Breakdown.
​How to Explore the Report
​Option 1 (Quick View): Check the Images/ folder for high-resolution screenshots of Page 1 (Sales Overview) and Page 2 (Seasonality & Forecast).
​Option 2 (Interactive View): Download the Seasonality_Sales_Report.pbix file from the PowerBI_Report/ folder and open it with Power BI Desktop to interact with the slicers and filters.
